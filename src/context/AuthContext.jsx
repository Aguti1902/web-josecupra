...
function buildUser(authUser, profile) {
  ...
  if (profile) {
    ...
    return {
      ...
      trialEndsAt: (meta.skippedTrial || cached?.skippedTrial) ? null : (meta.trialEndsAt ?? cached?.trialEndsAt ?? null),
      skippedTrial: !!(meta.skippedTrial || cached?.skippedTrial),
...
function snapshotToAuthUser(snap) {
  ...
  return {
    ...
    user_metadata: {
      ...
      trialEndsAt: snap.skippedTrial ? null : snap.trialEndsAt,
      skippedTrial: !!snap.skippedTrial,
