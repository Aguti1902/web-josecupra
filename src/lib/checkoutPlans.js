...
export const PLANS = {
  ...
  "player-essential": {
    ...
    audience: "player",
    name: "Básico",
    tagline: "Plan IA · ranking · tests",
    price: 29,
    period: "/ mes",
    limits: { maxTeams: null, maxPlayers: null },
    features: [
      "Planificación individual personalizada (IA)",
      "Ranking interno",
      "Tests físicos con seguimiento",
  ...
  "player-pro": {
    ...
    audience: "player",
    name: "Premium",
    tagline: "Seguimiento humano · 30 plazas",
    price: 99,
    period: "/ mes",
    limits: { maxTeams: null, maxPlayers: null },
    features: [
      ...
      "Videollamada inicial con preparador físico",
      "Seguimiento continuo por WhatsApp",
      "Plan diseñado y revisado manualmente",
      "Ajustes ilimitados del plan",
    ],
    color: "#F6CC12",
    bg: "#FEFAE7",
    highlight: true,
