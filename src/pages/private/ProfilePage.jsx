...
import { User, Shield, CheckCircle, AlertCircle, Hash, LogOut, ChevronRight, Camera, CreditCard, Sparkles, Calendar, RefreshCw, Lock, Mail, Eye, EyeOff, Save } from "lucide-react";
...
export default function ProfilePage() {
  ...
  // Club actual del jugador (código = identidad visual, no plantilla)
  ...
  // ── Aplicar código de club (descuento + identidad, sin equipo) ──
    ...
    <div className="dash-page space-y-6">
      ...
      <div className="bg-white border border-depro-border rounded-2xl p-6">
        ...
        {currentClub ? (
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-depro-gray mt-1.5">{t("profile.club_code_no_team")}</p>
                {currentClub.slogan && (
          ...
          /* Introducir código de descuento: identidad visual, sin equipo */
