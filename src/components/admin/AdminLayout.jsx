...
const navGroups = [
  ...
  {
    label: "Clubs · Contenido",
    groupIcon: Sparkles,
    accent: "#38BDF8",
    items: [
      { to: "/admin/clubs", icon: Building2, label: "Clubs (auto / manual)", tour: "nav-clubs", hint: "Contenido dentro de cada club" },
      { to: "/admin/club-auto", icon: Sparkles, label: "Motor club auto", hint: "También en Clubs → Contenido" },
