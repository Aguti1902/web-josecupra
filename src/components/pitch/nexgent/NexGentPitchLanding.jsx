              ...
              <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                ...
                <div className="space-y-2 text-xs">
                  {[
                    ...
                    { t: "Sprint media cancha", v: "3.12s", r: "Top 2 plantilla" },
                    { t: "Carga sesión", v: "412 AU", r: "Óptima" },
                  ].map((m) => (
                    <div key={m.t} className="flex justify-between gap-2 py-2 border-b border-gray-50 last:border-0">
                      ...
                      <span className="font-bold text-gray-800 text-right">{m.v}<br /><span className="font-semibold" style={{ color: CLUB_ACCENT }}>{m.r}</span></span>
                    </div>
                  ))}
                </div>
              </div>
