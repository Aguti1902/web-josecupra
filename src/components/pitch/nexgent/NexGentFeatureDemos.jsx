    ...
    <BrowserFrame title="sesiones / ia-táctica">
      <div className="flex gap-3">
        ...
        <div className="flex-1 space-y-2">
          ...
          <div className="rounded-lg h-32 relative overflow-hidden border-2 border-green-900/30" style={{ background: `linear-gradient(180deg, ${PALMEIRAS.accent} 0%, #004d2a 100%)` }}>
