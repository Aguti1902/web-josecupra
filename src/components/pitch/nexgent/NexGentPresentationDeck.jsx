...
function AnimatedFeaturePanel({ featureId, active }) {
...
function SlideBullets({ items, size = "md" }) {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <header className="h-12 sm:h-14 border-b border-gray-200 flex items-center justify-between px-3 sm:px-6 flex-shrink-0 bg-white z-20">
        <Link to="/nexgent/pitch" className="flex items-center gap-1.5 text-xs sm:text-sm font-bold text-gray-600 hover:text-gray-900">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="text-center lg:text-left">
                <div className="flex items-center justify-center lg:justify-start gap-5 mb-8">
                  <img src={NEXGENT_LOGO} alt="NexGent" className="h-14 sm:h-20 object-contain" />
                  <span className="text-2xl text-gray-300">×</span>
                  <img src={DEPRO_LOGO} alt="DEPRO" className="h-11 sm:h-16 object-contain" />
                </div>
            ...
            <div className="max-w-3xl">
              {slide.logos && (
                <div className="flex items-center gap-3 mb-6">
                  <img src={NEXGENT_LOGO} alt="NexGent" className="h-8 object-contain" />
                  <span className="text-gray-300">×</span>
                  <img src={DEPRO_LOGO} alt="DEPRO" className="h-6 object-contain" />
                </div>
              )}
