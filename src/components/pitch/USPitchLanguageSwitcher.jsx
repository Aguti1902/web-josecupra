...
const STORAGE_KEY = "depro_us_pitch_lang";

export default function USPitchLanguageSwitcher() {
  const { i18n, t } = useTranslation("usPitch");
...
export function initUSPitchLanguage(i18n) {
  const stored = localStorage.getItem(STORAGE_KEY);
  const lang = stored === "es" || stored === "en" ? stored : "en";
