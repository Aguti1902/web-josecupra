...
import {
  Layers, Calendar, Target, ChevronDown, ChevronUp, ArrowRight, Info,
} from "lucide-react";
...
export default function CoachPlanning({ club, team }) {
  ...
  useEffect(() => {
    ...
    const m = loadOrGenerateMesociclo({
      clubId, teamId, config, startDate: mondayOfToday(), numWeeks: 4, library,
    });
    setMesociclo(m);
  }, [clubId, teamId, config, libraryReady]);
