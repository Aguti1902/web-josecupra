...
import { PALMEIRAS, DEPRO_ACCENT } from "@/lib/club-config";
...
function CompareCell({ value }: { value: boolean | string }) {
  ...
  return <span className="text-xs font-bold text-amber-600 capitalize">{value === "partial" ? "Parcial" : value === "addon" ? "Extra $" : "Limitado"}</span>;
}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-4 mb-6">
                <img src="/logo-nexgent.png" alt="NexGent" className="h-10 object-contain" />
                <span className="text-gray-300 text-xl">×</span>
                <img src="/logo.png" alt="DEPRO" className="h-8 object-contain" />
              </div>
              ...
              <div className="flex flex-wrap gap-3 mb-10">
                <Link href="/app/inicio" className="inline-flex items-center gap-2 text-white font-bold px-6 py-3.5 rounded-lg transition-colors hover:opacity-90" style={{ backgroundColor: ACCENT }}>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-4">
              NexGent + DEPRO = una sola plataforma
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
              <img src="/logo-nexgent.png" alt="NexGent" className="h-12 mb-4 object-contain" />
              <h3 className="font-black text-lg mb-2">NexGent</h3>
              <ul className="text-sm text-gray-600 space-y-2">
                <li className="flex gap-2"><CheckCircle2 size={14} className="text-green-500 flex-shrink-0 mt-0.5" /> IA táctica: texto → diagrama SVG</li>
                <li className="flex gap-2"><CheckCircle2 size={14} className="text-green-500 flex-shrink-0 mt-0.5" /> Clasificación inteligente de carga GPS</li>
                <li className="flex gap-2"><CheckCircle2 size={14} className="text-green-500 flex-shrink-0 mt-0.5" /> Chat del staff con resumen IA</li>
                <li className="flex gap-2"><CheckCircle2 size={14} className="text-green-500 flex-shrink-0 mt-0.5" /> Scouting, dirección deportiva, cantera</li>
              </ul>
            </div>
            <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
              <img src="/logo.png" alt="DEPRO" className="h-10 mb-4 object-contain" />
              <h3 className="font-black text-lg mb-2">DEPRO</h3>
              <ul className="text-sm text-gray-600 space-y-2">
                <li className="flex gap-2"><CheckCircle2 size={14} className="text-green-500 flex-shrink-0 mt-0.5" /> Periodización meso/microciclo</li>
                <li className="flex gap-2"><CheckCircle2 size={14} className="text-green-500 flex-shrink-0 mt-0.5" /> Tests físicos con ratings automáticos</li>
                <li className="flex gap-2"><CheckCircle2 size={14} className="text-green-500 flex-shrink-0 mt-0.5" /> White-label: logo, colores, equipos</li>
                <li className="flex gap-2"><CheckCircle2 size={14} className="text-green-500 flex-shrink-0 mt-0.5" /> PDFs de sesión y adherencia al plan</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section id="palmeiras" className="py-20 bg-gray-50 border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="max-w-2xl mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-4">
              Así se ve con {PALMEIRAS.shortName}
            </h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 rounded-2xl border border-gray-200 bg-white p-6 md:p-8 shadow-sm">
              ...
              <Link href="/app/inicio" className="inline-flex items-center gap-2 font-bold text-sm px-5 py-2.5 rounded-lg text-white transition-opacity hover:opacity-90" style={{ backgroundColor: CLUB_ACCENT }}>
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <div className="flex items-center justify-center gap-4 mb-8">
            <img src="/logo-nexgent.png" alt="NexGent" className="h-12 object-contain" />
